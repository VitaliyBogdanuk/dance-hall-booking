...
export function Input({ label, error, helperText, className = "", id, ...props }: InputProps) {
  ...
  return (
    <div className="w-full">
      ...
      <input
        id={inputId}
        className={`w-full px-4 py-3 text-base bg-white dark:bg-gray-900 border rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
          error
