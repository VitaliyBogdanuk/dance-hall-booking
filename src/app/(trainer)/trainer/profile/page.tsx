...
export default function ProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (form.specialties.trim()) {
        payload.specialties = form.specialties.trim();
      } else {
        payload.specialties = "";
      }
  ...
  return (
    <div className="w-full space-y-4 pb-20">
      <PageHeader title="My Profile" description="Manage your account and trainer information" />
        ...
        <Card>
          <CardContent className="p-4 space-y-4">
            ...
            <div className="pt-4 border-t border-gray-100">
              <h3 className="text-lg font-semibold text-text-primary mb-2">Trainer Information</h3>
              <Input
                label="Bio (optional)"
